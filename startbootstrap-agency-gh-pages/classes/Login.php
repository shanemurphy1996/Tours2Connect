...
class Login{
    ...
    private function dologinWithPostData()
    {
        ...
        if (empty($_POST['name'])) {
            ...
            $this->db_connection = new mysqli("127.0.0.1", "x14511863", "", "tours2connect");
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $user_name = $this->db_connection->real_escape_string($_POST['name']);
                // database query, getting all the info of the selected user (allows login via email address in the
                // username field)
                $sql = "SELECT id, username, user_email, password
                        FROM name
                        WHERE name = '".$name."' OR user_email = '".$user_name."'";
